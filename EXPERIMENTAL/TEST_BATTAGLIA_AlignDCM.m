...
if ~isonserver
    test_dirALL    ='/home/frosolone/BATTAGLIA_REULTS/SS_AlignDCM';
else
    test_dirALL    ='/home/frosolone/BATTAGLIA_REULTS/SS_AlignDCM';
end
%sessions = {'SK022','SK025','SK033','SK035','SK036','SK038','SK042','SK043',... % Frontal
%            'SK051','SK059','SK060','SK062','SK065','SK069','SK074'}; % Parietal
sessions = {'SK022'};
