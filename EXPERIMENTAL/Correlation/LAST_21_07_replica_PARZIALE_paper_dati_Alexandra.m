...
%% HEATMAP ACT --> OBS
M_smooth = imgaussfilt(corr_matrix_hat_act_obs, sigma);  % Image Processing Toolbox
...
for i = 1:n_lags
    ...
    for j = 1:n_lags
        ...
        mdl = fitlm(Xi, Xj);  % Usa tutte le colonne (multivariate multiple output)
        
        % Calcolo R² aggregato (media dei singoli R² per ogni dimensione)
