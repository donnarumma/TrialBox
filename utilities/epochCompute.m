...
for nTrials = 1:size(data_trials,1)
    [n_epoch,time_intervals,bin_intervals] = computeEpochIntervals(size(data_trials(nTrials).(InField),2)/fsample,t_epoch,overlap_percent,fsample);
...
out.time_intervals = time_intervals;
