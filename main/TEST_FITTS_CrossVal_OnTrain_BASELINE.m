% TEST_Fitts_CrossVal_OnTrain_Baseline_BASELINE.m
...
par.extractFITTS.dir            = 'epogo';
[EEG_trials,fsample]            = extractFITTS(indsub,par.extractFITTS);


% Align trials
par.alignTrials.events          = 'TargetON';
...
par.TimeSelect.t1            = -0.50; % in s from ZeroEvent time
par.TimeSelect.t2            = 0.0; % in s from ZeroEvent time
...
params.createStructResult.train_name = 'FittsBaseline';
params.createStructResult.train_tr1  = itr1;
params.createStructResult.train_tr2  = itr2;
params.createStructResult.test_name  = 'FittsBaseline';
...
params.updateTab.name       = 'Fitts_CrossVal_OnTrain_Baseline';
...
params.updateTab.name     = 'Fitts_CrossVal_OnTrain_Baseline_class';
params.updateTab.sheetnames = 'QDA';
