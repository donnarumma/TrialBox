% TEST_Graz_OnTest_pipeline2_GridSearc.m
...
for indsub = 9
    ...
    for deltaT = 1:2
        ...
        for attenuation = 10
            ...
            params.updateTab.name               = 'Graz_OnTest_pipeline2_GridSearc';
            ...
            params.updateTab.name               = 'Graz_OnTest_class_pipeline2_GridSearc';
            params.updateTab.sheetnames         = 'QDA';
