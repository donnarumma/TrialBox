% TEST_Graz_OnTest_postDPCA_pipeline7.m
...
% perform tsne
par.tsneModel.NumDimensions   = 8;
par.tsneModel.InField         = signal_name;
par.tsneModel.OutField        = signal_process2;
...
params.updateTab.name               = 'Graz_OnTest_postDPCA_pipe7';
...
params.updateTab.name               = 'Graz_OnTest_class_postDPCA_pipe7';
params.updateTab.sheetnames         = 'QDA';
