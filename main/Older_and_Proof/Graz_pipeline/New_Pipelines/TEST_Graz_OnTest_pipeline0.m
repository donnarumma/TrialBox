...
for indsub=subj
    ...
    par.TimeSelect.t2            = 0.8998+0.75; % in s from ZeroEvent time
    ...
    params.updateTab.name               = 'Graz_OnTest_pipeline0';
    ...
    params.updateTab.name               = 'Graz_OnTest_pipeline0_class';
    params.updateTab.sheetnames         = 'QDA';
