% TEST_Graz_CrossVal_OnTrain_pipeline2.m
...
% tsub1 = [0,0,1.3018,1.0606,1.4626,1.2214,1.3822,1.3018,1.5429];
...
for indsub = 1
    ...
    for deltaT = 1
        ...
        params.updateTab.name       = 'Graz_CrossVal_OnTrain_pipeline2';
        ...
        params.updateTab.name     = 'Graz_CrossVal_OnTrain_class_pipeline2';
        params.updateTab.sheetnames = 'QDA';
