...
for indsub = 3
    ...
    par.extractSound.multiEpoch     = false;
    ...
    params.updateTab.name       = 'Sound_MultiEpoch_SearcINT';
    ...
    params.updateTab.name     = 'Sound_MultiEpoch_class_SearcINT';
    params.updateTab.sheetnames = 'QDA';
...
cQDA = confusionmat(label_train,predictQDA_train);
cKNN = confusionmat(label_train,predictKNN_train);
cNBPW = confusionmat(label_train,predictNBPW_train);
