function TopoplotMiMEAN(W1,W2,par)
...
for i = 1:size(W1,1)
    ...
    subplot(2, 4, i);
    W1plot = W1{i,1};
    W1plotmean = mean(W1plot(:,1:2),2);
    % Plot topografico utilizzando 'topoplot'
    topoplot(W1plotmean, selected_chanlocs, 'maplimits', 'absmax', 'electrodes','pts','style', 'both', 'emarkersize', 10);
    % 'ptslabels');
    colorbar;
    ...
    subplot(2, 4, i+4);
    W2plot = W2{i,1};
    W2plotmean = mean(W2plot(:,1:2),2);
    % Plot topografico utilizzando 'topoplot'
    topoplot(W2plotmean, selected_chanlocs, 'maplimits', 'absmax', 'electrodes','pts','style', 'both', 'emarkersize', 10);
    % 'ptslabels');
    colorbar;
